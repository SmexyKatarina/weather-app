        ...
        for (let i = 0; i < hourlyWeather.time.length; i++) 
        {
            ...
            hourlyElements.push((
                <div className="hour-tile">
                    ...
                    <div className="hour-temp">Temp: {temp}°C (Feels Like: {apparent}°C)</div>
                    <div className="hour-wind">Wind Speed: {wind}Km/h</div>
                </div>
            ))
    ...
    return (
        <div id="weather-statistics" style={{ display: "none" }}>
            ...
            <div className="current-weather">
                <div className="current-temp">Temp: {currentWeather.temperature_2m}°C (Feels like: {currentWeather.apparent_temperature}°C)</div>
                <div className="current-wind">Wind Speed: {currentWeather.wind_speed_10m}Km/h</div>
            </div>
